...
export const about = {
  ...
  ambition:
    "I want to work at the frontier of AI engineering — shipping systems that are genuinely useful, not demos — and I'm building the public track record to prove it.",
};

export const experience = [
  {
    role: "AI Integration Research Intern",
  ...
  {
    role: "Software Engineering Consultant (Contract)",
    org: "Bacata Coffee",
    location: "Remote",
    dates: "Summer 2026 – Present",
    bullets: [
  ...
  },
  {
    ...
    bullets: [
      "Managing inbound/outbound lead pipelines across two service lines, deals from $200–$5,000",
      "20–40% lead-to-appointment conversion via structured qualification frameworks",
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "CRAFT Agents",
    summary:
      "An AI-assisted presentation-building tool with a multi-agent pipeline (Context → Roadmap → Assemble → Fine-Tune → Tell), RAG-backed document/image ingestion, and a React/FastAPI interface.",
    dates: "2025 – 2026",
    ...
    body: [
      "Built CRAFT, a multi-agent AI system that guides users through structuring a presentation via a 5-stage pipeline, using an orchestrator/worker-agent architecture with retry-and-escalation error handling and append-only state management.",
