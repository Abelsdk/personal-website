...
export const projects: Project[] = [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      outcome:
        "Independent technical delivery from requirements through store setup; translating business needs into a shippable commerce stack. Created an additional revenue channel with potential 25% increase to existing income.",
    },
  },
];
